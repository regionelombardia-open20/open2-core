...
class TaggableBehavior extends YiiTaggable
{
  ...
  */
  public function beforeDelete()
  {
	...
	if(isset(\Yii::$app->params['tagManageDeleteAll']) && \Yii::$app->params['tagManageDeleteAll']){
		if ((isset($_POST[$this->owner->formName()]) && isset($_POST[$this->owner->formName()]['tagValues']))) {
		  $tags = $_POST[$this->owner->formName()]['tagValues'];
		}
    ...
    $connection->createCommand()->update($pivot::tableName(), ['deleted_at' => $timestamp, 'deleted_by' => $userId],
    $query_condition)->execute();
  }
